...
<body x-data="{ open: true, darkMode: false, openLogoutModal: false }" :class="darkMode ? 'dark' : ''">
    <div class="relative flex bg-p-y-gradient dark:bg-gray-900">
        ...
        <div class="container-receipt my-5 px-10 mt-10">
          <h2 class="heading-receipt border-l-4 border-yellow-400 pl-4">Admin Profile</h2>
          ...
          <div class="receipt-card">
              <div class="card-body">
                ...
                <div class="row">
                  <div class="col-sm-3"><h6 class="mb-0">Admin ID #</h6></div>
          ...
          <div class="mt-6 text-right">
            <a href="admin_updateProcess.php" class="w-full bg-purple-custom hover:bg-purple-700 text-white font-bold py-3 px-4 rounded-lg transition duration-300 mt-6">Update Your Profile</a>
          </div>
        </div>
