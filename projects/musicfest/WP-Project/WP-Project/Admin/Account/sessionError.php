...
<body x-data="{ open: true, darkMode: false, openLogoutModal: false }" :class="darkMode ? 'dark' : ''">
    ...
    <!--Link to Admin-Success Update Profile-->
    <?php if ($page == 'successAdminUpt') { ?>
        <div class="logout-section">
            <div class="logout-container">
                <p class="logout-message">Succesfully update the data.</p>
                <a  class="logout-btn" href="/WP-Project/Admin/Account/adminProfile.php">View your account here.</a>
            </div>
        </div>
    <?php } ?>

    <!--Link to Admin-Error Update Profile-->
    <?php if ($page == 'errorAdminUpt') { ?>
        <div class="logout-section">
            <div class="logout-container">
                <p class="logout-message">Error in updating the data.</p>
                <a  class="logout-btn" href="/WP-Project/Admin/Account/adminProfile.php">Return to your accoun</a>
            </div>
        </div>
    <?php } ?>
</body>
