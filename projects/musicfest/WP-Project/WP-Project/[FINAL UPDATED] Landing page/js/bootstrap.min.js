...
Purpose: Adds interactive components like dropdowns, modals, and carousels.
Usage: Enables dynamic behavior in Bootstrap elements.
Key points:
- Modal popups [prompts to ask user is admin or just user]
- Navbar collapse
- Carousel sliders
*/
